...
PlayerModel::PlayerModel()
{
    ...
    connect(&thread, SIGNAL(newPosition(int,double,double)), this, SLOT(updatePlayer(int,double,double)));
...
void PlayerModel::updatePlayer(int playerindex, double longitude, double latitude)
{
